...
#define RESET_Pin    5              // пин перезагрузки модема
...
String MAC = "80-01-AA-01-00-01";   // МАС-Адрес устройства для индентификации на сервере narodmon.ru (придумать свое 80-01-XX-XX-XX-XX-XX)
String SENS = "martinhol221";       // Название устройства (придумать свое Citroen 566 или др. для отображения в программе и на карте)
...
Track = 10 - "Стоп" 
Track = 11 - "Команду поняла, выполняю"
Track = 12 - "Ждите" 
*/
