...
String call_phone= "+375000000000";         // телефон входящего вызова с автоподнятием трубки 
String SMS_phone = "+375000000000";         // телефон при звонке с которого произойдет автоматический запуск без снятия трубки
...
//  Serial.setTimeout(50);
 ...
 // SIM800.setTimeout(500);                 // тайм аут ожидания ответа
  ...
  Serial.println("Загрузка|MQTT|10/04/2018"); 
  delay (1000);
  SIM800_reset();
...
void callback(){                                                 // обратный звонок при появлении напряжения на входе IN1 в режиме охраны
  if (Security == true) SIM800.println("ATD"+call_phone+";"), delay(5000);} 
